...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/file_axis_3d.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn FileAxis3d(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        ...
        path(&[attr("d", "m8 18 4-4")]),
        path(&[attr("d", "M8 10v8h8")]),
    ])];
