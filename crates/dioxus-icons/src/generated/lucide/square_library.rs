...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/square_library.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn SquareLibrary(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        ...
        path(&[attr("d", "M7 7v10")]),
        path(&[attr("d", "M11 7v10")]),
        path(&[attr("d", "m15 7 2 10")]),
    ])];
