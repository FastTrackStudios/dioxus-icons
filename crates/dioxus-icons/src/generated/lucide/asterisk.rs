...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/asterisk.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn Asterisk(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "M12 6v12")]),
        path(&[attr("d", "M17.196 9 6.804 15")]),
        path(&[attr("d", "m6.804 9 10.392 6")]),
    ])];
