...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/heading_4.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn Heading4(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "M12 18V6")]),
        path(&[attr("d", "M17 10v3a1 1 0 0 0 1 1h3")]),
        path(&[attr("d", "M21 10v8")]),
        path(&[attr("d", "M4 12h8")]),
        path(&[attr("d", "M4 18V6")]),
    ])];
