...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/square_arrow_down_left.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn SquareArrowDownLeft(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        ...
        path(&[attr("d", "m16 8-8 8")]),
        path(&[attr("d", "M16 16H8V8")]),
    ])];
