...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/table_of_contents.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn TableOfContents(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "M16 5H3")]),
        path(&[attr("d", "M16 12H3")]),
        path(&[attr("d", "M16 19H3")]),
        path(&[attr("d", "M21 5h.01")]),
        path(&[attr("d", "M21 12h.01")]),
        path(&[attr("d", "M21 19h.01")]),
    ])];
