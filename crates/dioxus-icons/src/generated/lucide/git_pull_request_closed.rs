...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/git_pull_request_closed.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn GitPullRequestClosed(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        circle(&[attr("cx", "6"), attr("cy", "6"), attr("r", "3")]),
        path(&[attr("d", "M6 9v12")]),
        path(&[attr("d", "m21 3-6 6")]),
        path(&[attr("d", "m21 9-6-6")]),
        path(&[attr("d", "M18 11.5V15")]),
