...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/pin_off.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn PinOff(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "M12 17v5")]),
        path(&[attr("d", "M15 9.34V7a1 1 0 0 1 1-1 2 2 0 0 0 0-4H7.89")]),
