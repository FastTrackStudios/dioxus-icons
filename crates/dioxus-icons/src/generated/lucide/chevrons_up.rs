...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/chevrons_up.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn ChevronsUp(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "m17 11-5-5-5 5")]),
        path(&[attr("d", "m17 18-5-5-5 5")]),
    ])];
