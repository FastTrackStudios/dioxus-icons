...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/square_dashed_bottom_code.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn SquareDashedBottomCode(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "M10 9.5 8 12l2 2.5")]),
        path(&[attr("d", "M14 21h1")]),
        path(&[attr("d", "m14 9.5 2 2.5-2 2.5")]),
        path(&[attr(
            "d",
