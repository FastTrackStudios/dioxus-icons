...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/cloud_snow.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn CloudSnow(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        ...
        path(&[attr("d", "M8 19h.01")]),
        path(&[attr("d", "M12 17h.01")]),
        path(&[attr("d", "M12 21h.01")]),
        path(&[attr("d", "M16 15h.01")]),
        path(&[attr("d", "M16 19h.01")]),
    ])];
