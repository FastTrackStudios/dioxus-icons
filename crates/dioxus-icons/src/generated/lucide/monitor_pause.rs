...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/monitor_pause.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn MonitorPause(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "M10 13V7")]),
        path(&[attr("d", "M14 13V7")]),
        rect(&[
            attr("height", "14"),
            attr("rx", "2"),
            attr("width", "20"),
