...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/clock_alert.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn ClockAlert(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "M12 6v6l4 2")]),
        path(&[attr("d", "M20 12v5")]),
        path(&[attr("d", "M20 21h.01")]),
        path(&[attr("d", "M21.25 8.2A10 10 0 1 0 16 21.16")]),
    ])];
