...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/arrow_up_wide_narrow.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn ArrowUpWideNarrow(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "m3 8 4-4 4 4")]),
        path(&[attr("d", "M7 4v16")]),
        path(&[attr("d", "M11 12h10")]),
        path(&[attr("d", "M11 16h7")]),
        path(&[attr("d", "M11 20h4")]),
    ])];
