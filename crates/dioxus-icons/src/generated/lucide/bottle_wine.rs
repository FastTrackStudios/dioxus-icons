...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/bottle_wine.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn BottleWine(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        ...
        path(&[attr("d", "M17 13h-4a1 1 0 0 0-1 1v3a1 1 0 0 0 1 1h4")]),
    ])];
