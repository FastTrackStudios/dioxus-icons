...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/move_down_right.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn MoveDownRight(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "M19 13V19H13")]),
        path(&[attr("d", "M5 5L19 19")]),
    ])];
