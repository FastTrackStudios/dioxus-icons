...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/file_image.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn FileImage(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        ...
        circle(&[attr("cx", "10"), attr("cy", "12"), attr("r", "2")]),
        path(&[attr("d", "m20 17-1.296-1.296a2.41 2.41 0 0 0-3.408 0L9 22")]),
    ])];
