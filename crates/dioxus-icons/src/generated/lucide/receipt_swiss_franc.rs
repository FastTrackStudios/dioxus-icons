...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/receipt_swiss_franc.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn ReceiptSwissFranc(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "M10 11h4")]),
        path(&[attr("d", "M10 17V7h5")]),
        path(&[attr(
            "d",
