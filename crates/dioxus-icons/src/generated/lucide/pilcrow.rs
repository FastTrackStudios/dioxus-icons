...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/pilcrow.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn Pilcrow(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "M13 4v16")]),
        path(&[attr("d", "M17 4v16")]),
        path(&[attr("d", "M19 4H9.5a4.5 4.5 0 0 0 0 9H13")]),
    ])];
