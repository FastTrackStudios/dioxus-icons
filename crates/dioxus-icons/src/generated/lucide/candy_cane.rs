...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/candy_cane.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn CandyCane(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr(
            "d",
            "M5.7 21a2 2 0 0 1-3.5-2l8.6-14a6 6 0 0 1 10.4 6 2 2 0 1 1-3.464-2 2 2 0 1 0-3.464-2Z",
        )]),
        path(&[attr("d", "M17.75 7 15 2.1")]),
        path(&[attr("d", "M10.9 4.8 13 9")]),
        path(&[attr("d", "m7.9 9.7 2 4.4")]),
        path(&[attr("d", "M4.9 14.7 7 18.9")]),
    ])];
