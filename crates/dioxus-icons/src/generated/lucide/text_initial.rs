...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/text_initial.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn TextInitial(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "M15 5h6")]),
        path(&[attr("d", "M15 12h6")]),
        path(&[attr("d", "M3 19h18")]),
        path(&[attr("d", "m3 12 3.553-7.724a.5.5 0 0 1 .894 0L11 12")]),
        path(&[attr("d", "M3.92 10h6.16")]),
    ])];
