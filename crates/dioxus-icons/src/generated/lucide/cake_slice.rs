...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/cake_slice.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn CakeSlice(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "M16 13H3")]),
        path(&[attr("d", "M16 17H3")]),
        path(&[attr(
            "d",
        ...
        circle(&[attr("cx", "9"), attr("cy", "7"), attr("r", "2")]),
    ])];
