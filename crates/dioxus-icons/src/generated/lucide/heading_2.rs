...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/heading_2.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn Heading2(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "M4 12h8")]),
        path(&[attr("d", "M4 18V6")]),
        path(&[attr("d", "M12 18V6")]),
        path(&[attr("d", "M21 18h-4c0-4 4-3 4-6 0-1.5-2-2.5-4-1")]),
    ])];
