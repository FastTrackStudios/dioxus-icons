...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/scale_3d.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn Scale3d(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "M5 7v11a1 1 0 0 0 1 1h11")]),
        path(&[attr("d", "M5.293 18.707 11 13")]),
