...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/shopping_bag.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn ShoppingBag(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "M16 10a4 4 0 0 1-8 0")]),
        path(&[attr("d", "M3.103 6.034h17.794")]),
        path(&[attr(
            "d",
