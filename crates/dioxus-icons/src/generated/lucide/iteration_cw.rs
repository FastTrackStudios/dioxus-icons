...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/iteration_cw.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn IterationCw(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "M4 10a8 8 0 1 1 8 8H4")]),
        path(&[attr("d", "m8 22-4-4 4-4")]),
    ])];
