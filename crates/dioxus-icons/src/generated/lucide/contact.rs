...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/contact.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn Contact(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "M16 2v2")]),
        path(&[attr("d", "M7 22v-2a2 2 0 0 1 2-2h6a2 2 0 0 1 2 2v2")]),
        path(&[attr("d", "M8 2v2")]),
        circle(&[attr("cx", "12"), attr("cy", "11"), attr("r", "3")]),
        rect(&[
            attr("height", "18"),
            attr("rx", "2"),
            attr("width", "18"),
