...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/tally_1.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn Tally1(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[path(&[attr("d", "M4 4v16")])])];
