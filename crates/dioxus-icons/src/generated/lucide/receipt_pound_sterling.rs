...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/receipt_pound_sterling.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn ReceiptPoundSterling(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "M10 17V9.5a1 1 0 0 1 5 0")]),
        path(&[attr(
            "d",
