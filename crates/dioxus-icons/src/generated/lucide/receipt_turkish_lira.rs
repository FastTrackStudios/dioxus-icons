...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/receipt_turkish_lira.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn ReceiptTurkishLira(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "M10 7v10a5 5 0 0 0 5-5")]),
        path(&[attr("d", "m14 8-6 3")]),
        path(&[attr(
            "d",
