...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/screen_share.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn ScreenShare(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        ...
        path(&[attr("d", "m17 8 5-5")]),
        path(&[attr("d", "M17 3h5v5")]),
    ])];
