...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/file_code.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn FileCode(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        ...
        path(&[attr("d", "M10 12.5 8 15l2 2.5")]),
        path(&[attr("d", "m14 12.5 2 2.5-2 2.5")]),
    ])];
