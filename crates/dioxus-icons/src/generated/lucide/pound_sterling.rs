...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/pound_sterling.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn PoundSterling(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "M18 7c0-5.333-8-5.333-8 0")]),
        path(&[attr("d", "M10 7v14")]),
        path(&[attr("d", "M6 21h12")]),
        path(&[attr("d", "M6 13h10")]),
    ])];
