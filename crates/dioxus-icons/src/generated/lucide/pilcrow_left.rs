...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/pilcrow_left.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn PilcrowLeft(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "M14 3v11")]),
        path(&[attr("d", "M14 9h-3a3 3 0 0 1 0-6h9")]),
        path(&[attr("d", "M18 3v11")]),
        path(&[attr("d", "M22 18H2l4-4")]),
        path(&[attr("d", "m6 22-4-4")]),
    ])];
