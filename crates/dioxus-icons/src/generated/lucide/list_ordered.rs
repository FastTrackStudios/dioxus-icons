...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/list_ordered.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn ListOrdered(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "M11 5h10")]),
        path(&[attr("d", "M11 12h10")]),
        path(&[attr("d", "M11 19h10")]),
        path(&[attr("d", "M4 4h1v5")]),
        path(&[attr("d", "M4 9h2")]),
        path(&[attr(
            "d",
