...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/zodiac_cancer.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn ZodiacCancer(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "M21 14.5A9 6.5 0 0 1 5.5 19")]),
        path(&[attr("d", "M3 9.5A9 6.5 0 0 1 18.5 5")]),
        circle(&[attr("cx", "17.5"), attr("cy", "14.5"), attr("r", "3.5")]),
        circle(&[attr("cx", "6.5"), attr("cy", "9.5"), attr("r", "3.5")]),
    ])];
