...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/scissors.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn Scissors(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        circle(&[attr("cx", "6"), attr("cy", "6"), attr("r", "3")]),
        path(&[attr("d", "M8.12 8.12 12 12")]),
        path(&[attr("d", "M20 4 8.12 15.88")]),
        circle(&[attr("cx", "6"), attr("cy", "18"), attr("r", "3")]),
        path(&[attr("d", "M14.8 14.8 20 20")]),
    ])];
