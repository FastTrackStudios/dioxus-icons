...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/anchor.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn Anchor(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "M12 6v16")]),
        path(&[attr("d", "m19 13 2-1a9 9 0 0 1-18 0l2 1")]),
        path(&[attr("d", "M9 11h6")]),
