...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/square_function.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn SquareFunction(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        ...
        path(&[attr("d", "M9 17c2 0 2.8-1 2.8-2.8V10c0-2 1-3.3 3.2-3")]),
        path(&[attr("d", "M9 11.2h5.7")]),
    ])];
