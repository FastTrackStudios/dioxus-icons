...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/square_user_round.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn SquareUserRound(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "M18 21a6 6 0 0 0-12 0")]),
