...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/circle_arrow_out_down_right.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn CircleArrowOutDownRight(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "M12 22a10 10 0 1 1 10-10")]),
        path(&[attr("d", "M22 22 12 12")]),
        path(&[attr("d", "M22 16v6h-6")]),
    ])];
