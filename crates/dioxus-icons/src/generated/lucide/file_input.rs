...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/file_input.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn FileInput(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        ...
        path(&[attr("d", "M2 15h10")]),
        path(&[attr("d", "m9 18 3-3-3-3")]),
    ])];
