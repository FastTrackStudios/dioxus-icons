...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/badge_russian_ruble.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn BadgeRussianRuble(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        ...
        path(&[attr("d", "M9 16h5")]),
        path(&[attr("d", "M9 12h5a2 2 0 1 0 0-4h-3v9")]),
    ])];
