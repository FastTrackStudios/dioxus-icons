...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/chevron_up.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn ChevronUp(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[path(&[attr("d", "m18 15-6-6-6 6")])])];
