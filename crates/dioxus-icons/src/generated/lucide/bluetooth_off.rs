...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/bluetooth_off.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn BluetoothOff(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "m17 17-5 5V12l-5 5")]),
        path(&[attr("d", "m2 2 20 20")]),
        path(&[attr("d", "M14.5 9.5 17 7l-5-5v4.5")]),
    ])];
