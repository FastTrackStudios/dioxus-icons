...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/case_sensitive.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn CaseSensitive(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "m2 16 4.039-9.69a.5.5 0 0 1 .923 0L11 16")]),
        path(&[attr("d", "M22 9v7")]),
        path(&[attr("d", "M3.304 13h6.392")]),
        circle(&[attr("cx", "18.5"), attr("cy", "12.5"), attr("r", "3.5")]),
    ])];
