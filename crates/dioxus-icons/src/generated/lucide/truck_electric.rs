...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/truck_electric.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn TruckElectric(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "M14 19V7a2 2 0 0 0-2-2H9")]),
        path(&[attr("d", "M15 19H9")]),
        path(&[attr(
            "d",
            "M19 19h2a1 1 0 0 0 1-1v-3.65a1 1 0 0 0-.22-.62L18.3 9.38a1 1 0 0 0-.78-.38H14",
        )]),
        path(&[attr("d", "M2 13v5a1 1 0 0 0 1 1h2")]),
        path(&[attr(
            "d",
            "M4 3 2.15 5.15a.495.495 0 0 0 .35.86h2.15a.47.47 0 0 1 .35.86L3 9.02",
        )]),
        circle(&[attr("cx", "17"), attr("cy", "19"), attr("r", "2")]),
        circle(&[attr("cx", "7"), attr("cy", "19"), attr("r", "2")]),
    ])];
