...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/picture_in_picture.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn PictureInPicture(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "M2 10h6V4")]),
        path(&[attr("d", "m2 4 6 6")]),
        path(&[attr("d", "M21 10V7a2 2 0 0 0-2-2h-7")]),
        path(&[attr("d", "M3 14v2a2 2 0 0 0 2 2h3")]),
        rect(&[
            attr("height", "7"),
            attr("rx", "1"),
            attr("width", "10"),
