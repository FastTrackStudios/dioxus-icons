...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/radius.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn Radius(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "M20.34 17.52a10 10 0 1 0-2.82 2.82")]),
        circle(&[attr("cx", "19"), attr("cy", "19"), attr("r", "2")]),
        path(&[attr("d", "m13.41 13.41 4.18 4.18")]),
