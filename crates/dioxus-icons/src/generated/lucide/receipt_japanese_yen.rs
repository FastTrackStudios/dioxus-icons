...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/receipt_japanese_yen.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn ReceiptJapaneseYen(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "m12 10 3-3")]),
        path(&[attr(
            "d",
