...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/zodiac_aries.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn ZodiacAries(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "M12 7.5a4.5 4.5 0 1 1 5 4.5")]),
        path(&[attr("d", "M7 12a4.5 4.5 0 1 1 5-4.5V21")]),
    ])];
