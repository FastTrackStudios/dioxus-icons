...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/move_down.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn MoveDown(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "M8 18L12 22L16 18")]),
        path(&[attr("d", "M12 2V22")]),
    ])];
