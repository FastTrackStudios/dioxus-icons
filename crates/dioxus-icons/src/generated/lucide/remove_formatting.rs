...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/remove_formatting.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn RemoveFormatting(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "M4 7V4h16v3")]),
        path(&[attr("d", "M5 20h6")]),
        path(&[attr("d", "M13 4 8 20")]),
        path(&[attr("d", "m15 15 5 5")]),
        path(&[attr("d", "m20 15-5 5")]),
    ])];
