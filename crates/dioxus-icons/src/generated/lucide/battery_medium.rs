...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/battery_medium.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn BatteryMedium(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "M10 14v-4")]),
        path(&[attr("d", "M22 14v-4")]),
        path(&[attr("d", "M6 14v-4")]),
        rect(&[
            attr("height", "12"),
            attr("rx", "2"),
            attr("width", "16"),
