...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/syringe.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn Syringe(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "m18 2 4 4")]),
        path(&[attr("d", "m17 7 3-3")]),
        path(&[attr(
            "d",
            "M19 9 8.7 19.3c-1 1-2.5 1-3.4 0l-.6-.6c-1-1-1-2.5 0-3.4L15 5",
        )]),
        path(&[attr("d", "m9 11 4 4")]),
        path(&[attr("d", "m5 19-3 3")]),
        path(&[attr("d", "m14 4 6 6")]),
    ])];
