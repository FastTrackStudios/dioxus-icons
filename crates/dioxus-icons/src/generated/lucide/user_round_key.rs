...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/user_round_key.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn UserRoundKey(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "M19 11v6")]),
        path(&[attr("d", "M19 13h2")]),
        path(&[attr("d", "M2 21a8 8 0 0 1 12.868-6.349")]),
