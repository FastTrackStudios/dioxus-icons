...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/separator_horizontal.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn SeparatorHorizontal(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "m16 16-4 4-4-4")]),
        path(&[attr("d", "M3 12h18")]),
        path(&[attr("d", "m8 8 4-4 4 4")]),
    ])];
