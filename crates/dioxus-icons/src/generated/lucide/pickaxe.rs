...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/pickaxe.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn Pickaxe(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "m14 13-8.381 8.38a1 1 0 0 1-3.001-3L11 9.999")]),
        path(&[attr(
            "d",
