...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/reply.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn Reply(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "M20 18v-2a4 4 0 0 0-4-4H4")]),
        path(&[attr("d", "m9 17-5-5 5-5")]),
    ])];
