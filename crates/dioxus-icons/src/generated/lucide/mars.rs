...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/mars.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn Mars(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "M16 3h5v5")]),
        path(&[attr("d", "m21 3-6.75 6.75")]),
        circle(&[attr("cx", "10"), attr("cy", "14"), attr("r", "6")]),
    ])];
