...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/move_diagonal_2.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn MoveDiagonal2(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "M19 13v6h-6")]),
        path(&[attr("d", "M5 11V5h6")]),
        path(&[attr("d", "m5 5 14 14")]),
    ])];
