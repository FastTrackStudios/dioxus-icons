...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/non_binary.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn NonBinary(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "M12 2v10")]),
        path(&[attr("d", "m8.5 4 7 4")]),
        path(&[attr("d", "m8.5 8 7-4")]),
