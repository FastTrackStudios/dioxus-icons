...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/clipboard_pen_line.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn ClipboardPenLine(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        ...
        path(&[attr("d", "M16 4h2a2 2 0 0 1 1.73 1")]),
        path(&[attr("d", "M8 18h1")]),
        path(&[attr(
            "d",
