...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/sport_shoe.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn SportShoe(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "m15 10.42 4.8-5.07")]),
        path(&[attr("d", "M19 18h3")]),
        path(&[attr(
            "d",
