...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/circle_fading_arrow_up.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn CircleFadingArrowUp(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "M12 2a10 10 0 0 1 7.38 16.75")]),
        path(&[attr("d", "m16 12-4-4-4 4")]),
        path(&[attr("d", "M12 16V8")]),
