...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/circle_arrow_out_up_left.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn CircleArrowOutUpLeft(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "M2 8V2h6")]),
        path(&[attr("d", "m2 2 10 10")]),
        path(&[attr("d", "M12 2A10 10 0 1 1 2 12")]),
    ])];
