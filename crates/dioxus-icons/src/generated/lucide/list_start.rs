...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/list_start.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn ListStart(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "M3 5h6")]),
        path(&[attr("d", "M3 12h13")]),
        path(&[attr("d", "M3 19h13")]),
        path(&[attr("d", "m16 8-3-3 3-3")]),
        path(&[attr("d", "M21 19V7a2 2 0 0 0-2-2h-6")]),
    ])];
