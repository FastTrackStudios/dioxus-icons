...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/venetian_mask.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn VenetianMask(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "M18 11c-1.5 0-2.5.5-3 2")]),
        path(&[attr(
            "d",
        ...
        path(&[attr("d", "M6 11c1.5 0 2.5.5 3 2")]),
    ])];
