...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/folder_open_dot.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn FolderOpenDot(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        ...
        circle(&[attr("cx", "14"), attr("cy", "15"), attr("r", "1")]),
    ])];
