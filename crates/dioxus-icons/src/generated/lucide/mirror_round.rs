...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/mirror_round.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn MirrorRound(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "M10 6.6 8.6 8")]),
        path(&[attr("d", "M12 18v4")]),
        path(&[attr("d", "M15 7.5 9.5 13")]),
        path(&[attr("d", "M7 22h10")]),
        circle(&[attr("cx", "12"), attr("cy", "10"), attr("r", "8")]),
    ])];
