...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/cloud_hail.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn CloudHail(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr(
            "d",
            "M4 14.899A7 7 0 1 1 15.71 8h1.79a4.5 4.5 0 0 1 2.5 8.242",
        )]),
        path(&[attr("d", "M16 14v2")]),
        path(&[attr("d", "M8 14v2")]),
        path(&[attr("d", "M16 20h.01")]),
        path(&[attr("d", "M8 20h.01")]),
        path(&[attr("d", "M12 16v2")]),
        path(&[attr("d", "M12 22h.01")]),
    ])];
