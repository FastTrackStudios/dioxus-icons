...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/square_parking.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn SquareParking(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        ...
        path(&[attr("d", "M9 17V7h4a3 3 0 0 1 0 6H9")]),
    ])];
