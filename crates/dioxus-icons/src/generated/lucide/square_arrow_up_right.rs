...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/square_arrow_up_right.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn SquareArrowUpRight(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        ...
        path(&[attr("d", "M8 8h8v8")]),
        path(&[attr("d", "m8 16 8-8")]),
    ])];
