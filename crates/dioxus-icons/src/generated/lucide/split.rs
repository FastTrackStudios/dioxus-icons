...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/split.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn Split(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "M16 3h5v5")]),
        path(&[attr("d", "M8 3H3v5")]),
        path(&[attr("d", "M12 22v-8.3a4 4 0 0 0-1.172-2.872L3 3")]),
