...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/file_music.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn FileMusic(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        ...
        path(&[attr("d", "M8 20v-7l3 1.474")]),
        circle(&[attr("cx", "6"), attr("cy", "20"), attr("r", "2")]),
    ])];
