...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/rectangle_ellipsis.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn RectangleEllipsis(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        ...
        path(&[attr("d", "M17 12h.01")]),
        path(&[attr("d", "M7 12h.01")]),
    ])];
