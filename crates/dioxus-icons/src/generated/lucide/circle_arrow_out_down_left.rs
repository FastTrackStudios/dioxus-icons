...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/circle_arrow_out_down_left.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn CircleArrowOutDownLeft(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "M2 12a10 10 0 1 1 10 10")]),
        path(&[attr("d", "m2 22 10-10")]),
        path(&[attr("d", "M8 22H2v-6")]),
    ])];
