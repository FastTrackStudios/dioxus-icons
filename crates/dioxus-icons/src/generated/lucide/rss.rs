...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/rss.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn Rss(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "M4 11a9 9 0 0 1 9 9")]),
        path(&[attr("d", "M4 4a16 16 0 0 1 16 16")]),
