...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/briefcase_medical.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn BriefcaseMedical(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "M12 11v4")]),
        path(&[attr("d", "M14 13h-4")]),
        path(&[attr("d", "M16 6V4a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v2")]),
        path(&[attr("d", "M18 6v14")]),
        path(&[attr("d", "M6 6v14")]),
        rect(&[
            attr("height", "14"),
            attr("rx", "2"),
