...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/list_chevrons_up_down.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn ListChevronsUpDown(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "M3 5h8")]),
        path(&[attr("d", "M3 12h8")]),
        path(&[attr("d", "M3 19h8")]),
        path(&[attr("d", "m15 8 3-3 3 3")]),
        path(&[attr("d", "m15 16 3 3 3-3")]),
    ])];
