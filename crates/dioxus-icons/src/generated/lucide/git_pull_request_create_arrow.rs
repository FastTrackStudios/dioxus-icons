...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/git_pull_request_create_arrow.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn GitPullRequestCreateArrow(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        circle(&[attr("cx", "5"), attr("cy", "6"), attr("r", "3")]),
        path(&[attr("d", "M5 9v12")]),
        path(&[attr("d", "m15 9-3-3 3-3")]),
        path(&[attr("d", "M12 6h5a2 2 0 0 1 2 2v3")]),
        path(&[attr("d", "M19 15v6")]),
        path(&[attr("d", "M22 18h-6")]),
    ])];
