...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/git_pull_request_create.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn GitPullRequestCreate(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        circle(&[attr("cx", "6"), attr("cy", "6"), attr("r", "3")]),
        path(&[attr("d", "M6 9v12")]),
        path(&[attr("d", "M13 6h3a2 2 0 0 1 2 2v3")]),
