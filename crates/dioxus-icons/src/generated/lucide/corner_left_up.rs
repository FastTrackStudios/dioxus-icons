...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/corner_left_up.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn CornerLeftUp(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "M14 9 9 4 4 9")]),
        path(&[attr("d", "M20 20h-7a4 4 0 0 1-4-4V4")]),
    ])];
