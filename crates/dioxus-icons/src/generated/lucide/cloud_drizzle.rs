...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/cloud_drizzle.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn CloudDrizzle(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        ...
        path(&[attr("d", "M8 19v1")]),
        path(&[attr("d", "M8 14v1")]),
        path(&[attr("d", "M16 19v1")]),
        path(&[attr("d", "M16 14v1")]),
        path(&[attr("d", "M12 21v1")]),
        path(&[attr("d", "M12 16v1")]),
    ])];
