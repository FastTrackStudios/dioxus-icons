...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/motorbike.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn Motorbike(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "m18 14-1-3")]),
        path(&[attr("d", "m3 9 6 2a2 2 0 0 1 2-2h2a2 2 0 0 1 1.99 1.81")]),
        path(&[attr(
            "d",
            "M8 17h3a1 1 0 0 0 1-1 6 6 0 0 1 6-6 1 1 0 0 0 1-1v-.75A5 5 0 0 0 17 5",
        )]),
        circle(&[attr("cx", "19"), attr("cy", "17"), attr("r", "3")]),
        circle(&[attr("cx", "5"), attr("cy", "17"), attr("r", "3")]),
    ])];
