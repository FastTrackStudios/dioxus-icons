...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/check_check.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn CheckCheck(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "M18 6 7 17l-5-5")]),
        path(&[attr("d", "m22 10-7.5 7.5L13 16")]),
    ])];
