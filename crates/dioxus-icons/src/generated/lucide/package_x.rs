...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/package_x.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn PackageX(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "M12 22V12")]),
        path(&[attr("d", "m16.5 14.5 5 5")]),
        path(&[attr("d", "m16.5 19.5 5-5")]),
        path(&[attr(
            "d",
