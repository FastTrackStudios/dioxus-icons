...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/door_closed.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn DoorClosed(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "M10 12h.01")]),
        path(&[attr("d", "M18 20V6a2 2 0 0 0-2-2H8a2 2 0 0 0-2 2v14")]),
