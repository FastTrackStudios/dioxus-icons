...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/briefcase.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn Briefcase(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "M16 20V4a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v16")]),
        rect(&[
            attr("height", "14"),
            attr("rx", "2"),
            attr("width", "20"),
