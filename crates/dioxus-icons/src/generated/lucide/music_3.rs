...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/music_3.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn Music3(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        circle(&[attr("cx", "12"), attr("cy", "18"), attr("r", "4")]),
        path(&[attr("d", "M16 18V2")]),
    ])];
