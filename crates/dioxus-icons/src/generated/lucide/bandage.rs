...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/bandage.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn Bandage(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "M10 10.01h.01")]),
        path(&[attr("d", "M10 14.01h.01")]),
        path(&[attr("d", "M14 10.01h.01")]),
        path(&[attr("d", "M14 14.01h.01")]),
        path(&[attr("d", "M18 6v12")]),
        path(&[attr("d", "M6 6v12")]),
        rect(&[
            attr("height", "12"),
            attr("rx", "2"),
