...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/align_horizontal_distribute_end.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn AlignHorizontalDistributeEnd(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        ...
        path(&[attr("d", "M10 2v20")]),
        path(&[attr("d", "M20 2v20")]),
    ])];
