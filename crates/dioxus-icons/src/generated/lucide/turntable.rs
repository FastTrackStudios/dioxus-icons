...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/turntable.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn Turntable(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "M10 12.01h.01")]),
        path(&[attr("d", "M18 8v4a8 8 0 0 1-1.07 4")]),
        circle(&[attr("cx", "10"), attr("cy", "12"), attr("r", "4")]),
        rect(&[
            attr("height", "16"),
            attr("rx", "2"),
            attr("width", "20"),
