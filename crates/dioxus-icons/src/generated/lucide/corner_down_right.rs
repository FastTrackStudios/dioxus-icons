...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/corner_down_right.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn CornerDownRight(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "m15 10 5 5-5 5")]),
        path(&[attr("d", "M4 4v7a4 4 0 0 0 4 4h12")]),
    ])];
