...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/code_xml.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn CodeXml(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "m18 16 4-4-4-4")]),
        path(&[attr("d", "m6 8-4 4 4 4")]),
        path(&[attr("d", "m14.5 4-5 16")]),
    ])];
