...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/corner_down_left.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn CornerDownLeft(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "M20 4v7a4 4 0 0 1-4 4H4")]),
        path(&[attr("d", "m9 10-5 5 5 5")]),
    ])];
