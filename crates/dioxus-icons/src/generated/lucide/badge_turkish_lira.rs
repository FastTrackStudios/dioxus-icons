...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/badge_turkish_lira.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn BadgeTurkishLira(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "M11 7v10a5 5 0 0 0 5-5")]),
        path(&[attr("d", "m15 8-6 3")]),
        path(&[attr(
            "d",
