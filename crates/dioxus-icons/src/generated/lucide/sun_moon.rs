...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/sun_moon.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn SunMoon(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        ...
        path(&[attr("d", "M16 12a4 4 0 0 0-4-4")]),
        path(&[attr("d", "m19 5-1.256 1.256")]),
