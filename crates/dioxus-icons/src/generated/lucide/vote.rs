...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/vote.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn Vote(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "m9 12 2 2 4-4")]),
        path(&[attr("d", "M5 7c0-1.1.9-2 2-2h10a2 2 0 0 1 2 2v12H5V7Z")]),
        path(&[attr("d", "M22 19H2")]),
    ])];
