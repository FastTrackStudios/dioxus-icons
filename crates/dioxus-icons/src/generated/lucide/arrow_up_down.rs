...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/arrow_up_down.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn ArrowUpDown(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "m21 16-4 4-4-4")]),
        path(&[attr("d", "M17 20V4")]),
