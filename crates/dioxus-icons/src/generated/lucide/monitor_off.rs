...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/monitor_off.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn MonitorOff(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "M12 17v4")]),
        path(&[attr("d", "M17 17H4a2 2 0 0 1-2-2V5a2 2 0 0 1 1.184-1.826")]),
