...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/lock_keyhole_open.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn LockKeyholeOpen(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        circle(&[attr("cx", "12"), attr("cy", "16"), attr("r", "1")]),
        rect(&[
            attr("height", "12"),
            attr("rx", "2"),
            attr("width", "18"),
        ...
        path(&[attr("d", "M7 10V7a5 5 0 0 1 9.33-2.5")]),
    ])];
