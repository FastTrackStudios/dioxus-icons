...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/beaker.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn Beaker(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "M4.5 3h15")]),
        path(&[attr("d", "M6 3v16a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2V3")]),
        path(&[attr("d", "M6 14h12")]),
    ])];
