...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/ligature.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn Ligature(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "M14 12h2v8")]),
        path(&[attr("d", "M14 20h4")]),
        path(&[attr("d", "M6 12h4")]),
        path(&[attr("d", "M6 20h4")]),
        path(&[attr("d", "M8 20V8a4 4 0 0 1 7.464-2")]),
    ])];
