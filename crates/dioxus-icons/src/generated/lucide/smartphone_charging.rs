...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/smartphone_charging.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn SmartphoneCharging(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        ...
        path(&[attr("d", "M12.667 8 10 12h4l-2.667 4")]),
    ])];
