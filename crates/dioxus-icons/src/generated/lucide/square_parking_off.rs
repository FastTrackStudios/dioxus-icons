...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/square_parking_off.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn SquareParkingOff(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr(
            "d",
            "M3.6 3.6A2 2 0 0 1 5 3h14a2 2 0 0 1 2 2v14a2 2 0 0 1-.59 1.41",
        )]),
        path(&[attr("d", "M3 8.7V19a2 2 0 0 0 2 2h10.3")]),
        path(&[attr("d", "m2 2 20 20")]),
        path(&[attr("d", "M13 13a3 3 0 1 0 0-6H9v2")]),
        path(&[attr("d", "M9 17v-2.3")]),
    ])];
