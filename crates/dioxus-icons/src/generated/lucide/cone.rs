...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/cone.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn Cone(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "m20.9 18.55-8-15.98a1 1 0 0 0-1.8 0l-8 15.98")]),
        ellipse(&[
            attr("cx", "12"),
            attr("cy", "19"),
            attr("rx", "9"),
