...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/paintbrush_vertical.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn PaintbrushVertical(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "M10 2v2")]),
        path(&[attr("d", "M14 2v4")]),
        path(&[attr("d", "M17 2a1 1 0 0 1 1 1v9H6V3a1 1 0 0 1 1-1z")]),
        path(&[attr(
            "d",
