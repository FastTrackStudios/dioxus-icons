...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/disc_3.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn Disc3(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        circle(&[attr("cx", "12"), attr("cy", "12"), attr("r", "10")]),
        path(&[attr("d", "M6 12c0-1.7.7-3.2 1.8-4.2")]),
        circle(&[attr("cx", "12"), attr("cy", "12"), attr("r", "2")]),
        path(&[attr("d", "M18 12c0 1.7-.7 3.2-1.8 4.2")]),
    ])];
