...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/check_line.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn CheckLine(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "M20 4L9 15")]),
        path(&[attr("d", "M21 19L3 19")]),
        path(&[attr("d", "M9 15L4 10")]),
    ])];
