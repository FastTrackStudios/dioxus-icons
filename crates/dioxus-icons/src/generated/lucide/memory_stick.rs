...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/memory_stick.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn MemoryStick(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "M12 12v-2")]),
        path(&[attr("d", "M12 18v-2")]),
        path(&[attr("d", "M16 12v-2")]),
        path(&[attr("d", "M16 18v-2")]),
        path(&[attr("d", "M2 11h1.5")]),
        path(&[attr("d", "M20 18v-2")]),
        path(&[attr("d", "M20.5 11H22")]),
        path(&[attr("d", "M4 18v-2")]),
        path(&[attr("d", "M8 12v-2")]),
        path(&[attr("d", "M8 18v-2")]),
        rect(&[
            attr("height", "10"),
            attr("rx", "2"),
            attr("width", "20"),
