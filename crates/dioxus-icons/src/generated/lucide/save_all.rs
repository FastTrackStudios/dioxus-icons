...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/save_all.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn SaveAll(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "M10 2v3a1 1 0 0 0 1 1h5")]),
        path(&[attr("d", "M18 18v-6a1 1 0 0 0-1-1h-6a1 1 0 0 0-1 1v6")]),
        path(&[attr("d", "M18 22H4a2 2 0 0 1-2-2V6")]),
        path(&[attr(
            "d",
