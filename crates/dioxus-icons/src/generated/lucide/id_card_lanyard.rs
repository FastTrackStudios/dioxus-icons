...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/id_card_lanyard.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn IdCardLanyard(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "M13.5 8h-3")]),
        path(&[attr(
            "d",
            "m15 2-1 2h3a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h3",
        )]),
        path(&[attr("d", "M16.899 22A5 5 0 0 0 7.1 22")]),
        path(&[attr("d", "m9 2 3 6")]),
        circle(&[attr("cx", "12"), attr("cy", "15"), attr("r", "3")]),
    ])];
