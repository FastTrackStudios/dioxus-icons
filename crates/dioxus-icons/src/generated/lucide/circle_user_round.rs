...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/circle_user_round.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn CircleUserRound(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "M17.925 20.056a6 6 0 0 0-11.851.001")]),
        circle(&[attr("cx", "12"), attr("cy", "11"), attr("r", "4")]),
