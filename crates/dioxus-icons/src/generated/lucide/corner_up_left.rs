...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/corner_up_left.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn CornerUpLeft(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "M20 20v-7a4 4 0 0 0-4-4H4")]),
        path(&[attr("d", "M9 14 4 9l5-5")]),
    ])];
