...
use crate::IconProps;
use crate::vdom::{attr, ellipse, icon_element, icon_template, svg};

#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/ellipse.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn Ellipse(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[ellipse(&[
        attr("cx", "12"),
        attr("cy", "12"),
        attr("rx", "10"),
        attr("ry", "6"),
