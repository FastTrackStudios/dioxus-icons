...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/arrow_right_to_line.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn ArrowRightToLine(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "M17 12H3")]),
        path(&[attr("d", "m11 18 6-6-6-6")]),
        path(&[attr("d", "M21 5v14")]),
    ])];
