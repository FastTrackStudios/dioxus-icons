...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/angry.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn Angry(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        circle(&[attr("cx", "12"), attr("cy", "12"), attr("r", "10")]),
        path(&[attr("d", "M16 16s-1.5-2-4-2-4 2-4 2")]),
        path(&[attr("d", "M7.5 8 10 9")]),
        path(&[attr("d", "m14 9 2.5-1")]),
