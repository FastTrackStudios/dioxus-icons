...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/file_signal.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn FileSignal(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        ...
        path(&[attr("d", "M11.5 13.5a2.5 2.5 0 0 1 0 3")]),
        path(&[attr("d", "M15 12a5 5 0 0 1 0 6")]),
    ])];
