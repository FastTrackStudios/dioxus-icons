...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/languages.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn Languages(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "m5 8 6 6")]),
        path(&[attr("d", "m4 14 6-6 2-3")]),
        path(&[attr("d", "M2 5h12")]),
        path(&[attr("d", "M7 2h1")]),
        path(&[attr("d", "m22 22-5-10-5 10")]),
        path(&[attr("d", "M14 18h6")]),
    ])];
