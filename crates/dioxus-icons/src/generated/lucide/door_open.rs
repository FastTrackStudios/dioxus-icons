...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/door_open.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn DoorOpen(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "M11 20H2")]),
        path(&[attr(
            "d",
            "M11 4.562v16.157a1 1 0 0 0 1.242.97L19 20V5.562a2 2 0 0 0-1.515-1.94l-4-1A2 2 0 0 0 11 4.561z",
        )]),
        path(&[attr("d", "M11 4H8a2 2 0 0 0-2 2v14")]),
        path(&[attr("d", "M14 12h.01")]),
        path(&[attr("d", "M22 20h-3")]),
    ])];
