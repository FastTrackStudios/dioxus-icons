...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/list_end.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn ListEnd(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "M16 5H3")]),
        path(&[attr("d", "M16 12H3")]),
        path(&[attr("d", "M9 19H3")]),
        path(&[attr("d", "m16 16-3 3 3 3")]),
        path(&[attr("d", "M21 5v12a2 2 0 0 1-2 2h-6")]),
    ])];
