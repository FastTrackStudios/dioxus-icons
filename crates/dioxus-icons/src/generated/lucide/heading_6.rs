...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/heading_6.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn Heading6(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "M4 12h8")]),
        path(&[attr("d", "M4 18V6")]),
        path(&[attr("d", "M12 18V6")]),
        circle(&[attr("cx", "19"), attr("cy", "16"), attr("r", "2")]),
        path(&[attr("d", "M20 10c-2 2-3 3.5-3 6")]),
    ])];
