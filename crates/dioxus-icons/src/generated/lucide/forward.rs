...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/forward.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn Forward(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "m15 17 5-5-5-5")]),
        path(&[attr("d", "M4 18v-2a4 4 0 0 1 4-4h12")]),
    ])];
