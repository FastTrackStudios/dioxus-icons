...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/user_round_x.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn UserRoundX(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "M2 21a8 8 0 0 1 11.873-7")]),
        circle(&[attr("cx", "10"), attr("cy", "8"), attr("r", "5")]),
        path(&[attr("d", "m17 17 5 5")]),
        path(&[attr("d", "m22 17-5 5")]),
    ])];
