...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/corner_left_down.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn CornerLeftDown(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "m14 15-5 5-5-5")]),
        path(&[attr("d", "M20 4h-7a4 4 0 0 0-4 4v12")]),
    ])];
