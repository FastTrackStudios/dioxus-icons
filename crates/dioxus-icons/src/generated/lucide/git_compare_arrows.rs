...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/git_compare_arrows.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn GitCompareArrows(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        circle(&[attr("cx", "5"), attr("cy", "6"), attr("r", "3")]),
        path(&[attr("d", "M12 6h5a2 2 0 0 1 2 2v7")]),
        path(&[attr("d", "m15 9-3-3 3-3")]),
        circle(&[attr("cx", "19"), attr("cy", "18"), attr("r", "3")]),
        path(&[attr("d", "M12 18H7a2 2 0 0 1-2-2V9")]),
