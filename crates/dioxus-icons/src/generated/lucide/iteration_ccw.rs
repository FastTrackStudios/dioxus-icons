...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/iteration_ccw.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn IterationCcw(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "m16 14 4 4-4 4")]),
        path(&[attr("d", "M20 10a8 8 0 1 0-8 8h8")]),
    ])];
