...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/trash_2.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn Trash2(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "M10 11v6")]),
        path(&[attr("d", "M14 11v6")]),
        path(&[attr("d", "M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6")]),
        path(&[attr("d", "M3 6h18")]),
        path(&[attr("d", "M8 6V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2")]),
    ])];
