...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/list_checks.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn ListChecks(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "M13 5h8")]),
        path(&[attr("d", "M13 12h8")]),
        path(&[attr("d", "M13 19h8")]),
        path(&[attr("d", "m3 17 2 2 4-4")]),
        path(&[attr("d", "m3 7 2 2 4-4")]),
    ])];
