...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/chart_column_increasing.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn ChartColumnIncreasing(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "M13 17V9")]),
        path(&[attr("d", "M18 17V5")]),
        path(&[attr("d", "M3 3v16a2 2 0 0 0 2 2h16")]),
        path(&[attr("d", "M8 17v-3")]),
    ])];
