...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/loader.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn Loader(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "M12 2v4")]),
        path(&[attr("d", "m16.2 7.8 2.9-2.9")]),
        path(&[attr("d", "M18 12h4")]),
        path(&[attr("d", "m16.2 16.2 2.9 2.9")]),
        path(&[attr("d", "M12 18v4")]),
        path(&[attr("d", "m4.9 19.1 2.9-2.9")]),
        path(&[attr("d", "M2 12h4")]),
        path(&[attr("d", "m4.9 4.9 2.9 2.9")]),
    ])];
