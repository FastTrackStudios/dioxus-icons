...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/slash.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn Slash(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[path(&[attr("d", "M22 2 2 22")])])];
