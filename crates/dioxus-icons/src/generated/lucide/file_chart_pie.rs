...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/file_chart_pie.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn FileChartPie(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        ...
        path(&[attr("d", "M4.017 11.512a6 6 0 1 0 8.466 8.475")]),
        path(&[attr(
            "d",
