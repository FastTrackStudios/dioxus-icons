...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/arrow_up_from_line.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn ArrowUpFromLine(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "m18 9-6-6-6 6")]),
        path(&[attr("d", "M12 3v14")]),
