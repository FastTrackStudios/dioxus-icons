...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/move_right.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn MoveRight(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "M18 8L22 12L18 16")]),
        path(&[attr("d", "M2 12H22")]),
    ])];
