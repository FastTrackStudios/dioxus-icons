...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/arrow_down_1_0.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn ArrowDown10(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "m3 16 4 4 4-4")]),
        path(&[attr("d", "M7 20V4")]),
        path(&[attr("d", "M17 10V4h-2")]),
        path(&[attr("d", "M15 10h4")]),
        rect(&[
            attr("height", "6"),
            attr("ry", "2"),
            attr("width", "4"),
