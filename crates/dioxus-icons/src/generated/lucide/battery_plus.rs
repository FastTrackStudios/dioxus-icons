...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/battery_plus.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn BatteryPlus(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        ...
        path(&[attr("d", "M7 12h6")]),
        path(&[attr("d", "M7.606 18H4a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h3.606")]),
    ])];
