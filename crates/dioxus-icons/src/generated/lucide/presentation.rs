...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/presentation.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn Presentation(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "M2 3h20")]),
        path(&[attr("d", "M21 3v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V3")]),
        path(&[attr("d", "m7 21 5-5 5 5")]),
    ])];
