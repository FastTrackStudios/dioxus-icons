...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/bluetooth_searching.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn BluetoothSearching(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "m7 7 10 10-5 5V2l5 5L7 17")]),
        path(&[attr("d", "M20.83 14.83a4 4 0 0 0 0-5.66")]),
