...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/arrow_down_right.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn ArrowDownRight(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "m7 7 10 10")]),
        path(&[attr("d", "M17 7v10H7")]),
    ])];
