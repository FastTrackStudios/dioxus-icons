...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/joystick.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn Joystick(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr(
            "d",
            "M21 17a2 2 0 0 0-2-2H5a2 2 0 0 0-2 2v2a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-2Z",
        )]),
        path(&[attr("d", "M6 15v-2")]),
        path(&[attr("d", "M12 15V9")]),
        circle(&[attr("cx", "12"), attr("cy", "6"), attr("r", "3")]),
    ])];
