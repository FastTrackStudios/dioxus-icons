...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/file_pen_line.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn FilePenLine(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        ...
        path(&[attr("d", "M14.487 7.858A1 1 0 0 1 14 7V2")]),
        path(&[attr(
            "d",
