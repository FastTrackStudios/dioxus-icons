...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/screen_share_off.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn ScreenShareOff(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        ...
        path(&[attr("d", "m22 3-5 5")]),
        path(&[attr("d", "m17 3 5 5")]),
    ])];
