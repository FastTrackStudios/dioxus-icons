...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/air_vent.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn AirVent(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "M18 17.5a2.5 2.5 0 1 1-4 2.03V12")]),
        path(&[attr(
            "d",
            "M6 12H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v5a2 2 0 0 1-2 2h-2",
        )]),
        path(&[attr("d", "M6 8h12")]),
        path(&[attr("d", "M6.6 15.572A2 2 0 1 0 10 17v-5")]),
    ])];
