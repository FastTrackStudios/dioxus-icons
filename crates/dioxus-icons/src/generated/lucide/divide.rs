...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/divide.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn Divide(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        circle(&[attr("cx", "12"), attr("cy", "6"), attr("r", "1")]),
        line(&[
            attr("x1", "5"),
            attr("x2", "19"),
            attr("y1", "12"),
        ...
        circle(&[attr("cx", "12"), attr("cy", "18"), attr("r", "1")]),
    ])];
