...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/film.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn Film(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        ...
        path(&[attr("d", "M7 3v18")]),
        path(&[attr("d", "M3 7.5h4")]),
        path(&[attr("d", "M3 12h18")]),
        path(&[attr("d", "M3 16.5h4")]),
        path(&[attr("d", "M17 3v18")]),
        path(&[attr("d", "M17 7.5h4")]),
        path(&[attr("d", "M17 16.5h4")]),
    ])];
