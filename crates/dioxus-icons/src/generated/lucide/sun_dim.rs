...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/sun_dim.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn SunDim(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        circle(&[attr("cx", "12"), attr("cy", "12"), attr("r", "4")]),
        path(&[attr("d", "M12 4h.01")]),
        path(&[attr("d", "M20 12h.01")]),
        path(&[attr("d", "M12 20h.01")]),
        path(&[attr("d", "M4 12h.01")]),
        path(&[attr("d", "M17.657 6.343h.01")]),
        path(&[attr("d", "M17.657 17.657h.01")]),
        path(&[attr("d", "M6.343 17.657h.01")]),
        path(&[attr("d", "M6.343 6.343h.01")]),
    ])];
