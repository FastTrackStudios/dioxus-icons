...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/chevrons_right.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn ChevronsRight(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "m6 17 5-5-5-5")]),
        path(&[attr("d", "m13 17 5-5-5-5")]),
    ])];
