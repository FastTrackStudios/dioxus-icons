...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/mirror_rectangular.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn MirrorRectangular(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "M11 6 8 9")]),
        path(&[attr("d", "m16 7-8 8")]),
        rect(&[
            attr("height", "20"),
            attr("rx", "2"),
            attr("width", "16"),
