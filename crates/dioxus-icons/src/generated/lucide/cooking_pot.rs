...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/cooking_pot.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn CookingPot(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "M2 12h20")]),
        path(&[attr("d", "M20 12v8a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2v-8")]),
        path(&[attr("d", "m4 8 16-4")]),
        path(&[attr(
            "d",
