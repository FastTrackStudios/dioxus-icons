...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/chevron_last.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn ChevronLast(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "m7 18 6-6-6-6")]),
        path(&[attr("d", "M17 6v12")]),
    ])];
