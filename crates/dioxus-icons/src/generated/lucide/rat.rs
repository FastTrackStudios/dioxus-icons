...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/rat.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn Rat(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "M13 22H4a2 2 0 0 1 0-4h12")]),
        path(&[attr("d", "M13.236 18a3 3 0 0 0-2.2-5")]),
        path(&[attr("d", "M16 9h.01")]),
        path(&[attr(
            "d",
