...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/timeline.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn Timeline(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "M4 12h.01")]),
        path(&[attr("d", "M4 16h.01")]),
        path(&[attr("d", "M4 20h.01")]),
        path(&[attr("d", "M4 4h.01")]),
        path(&[attr("d", "M4 8h.01")]),
        path(&[attr(
            "d",
