...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/package_search.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn PackageSearch(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "M12 22V12")]),
        path(&[attr("d", "M20.27 18.27 22 20")]),
        path(&[attr(
            "d",
        ...
        circle(&[attr("cx", "18.5"), attr("cy", "16.5"), attr("r", "2.5")]),
    ])];
