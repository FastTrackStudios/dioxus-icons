...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/zodiac_taurus.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn ZodiacTaurus(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        circle(&[attr("cx", "12"), attr("cy", "15"), attr("r", "6")]),
        path(&[attr("d", "M18 3A6 6 0 0 1 6 3")]),
    ])];
