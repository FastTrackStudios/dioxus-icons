...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/arrow_left_to_line.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn ArrowLeftToLine(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "M3 19V5")]),
        path(&[attr("d", "m13 6-6 6 6 6")]),
        path(&[attr("d", "M7 12h14")]),
    ])];
