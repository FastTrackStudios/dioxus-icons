...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/square_round_corner.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn SquareRoundCorner(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "M21 11a8 8 0 0 0-8-8")]),
        path(&[attr(
            "d",
