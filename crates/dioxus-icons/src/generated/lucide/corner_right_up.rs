...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/corner_right_up.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn CornerRightUp(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "m10 9 5-5 5 5")]),
        path(&[attr("d", "M4 20h7a4 4 0 0 0 4-4V4")]),
    ])];
