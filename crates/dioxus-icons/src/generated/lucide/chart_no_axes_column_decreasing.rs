...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/chart_no_axes_column_decreasing.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn ChartNoAxesColumnDecreasing(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "M5 21V3")]),
        path(&[attr("d", "M12 21V9")]),
        path(&[attr("d", "M19 21v-6")]),
    ])];
