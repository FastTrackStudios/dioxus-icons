...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/square_arrow_right_enter.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn SquareArrowRightEnter(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "m10 16 4-4-4-4")]),
        path(&[attr("d", "M3 12h11")]),
        path(&[attr(
            "d",
