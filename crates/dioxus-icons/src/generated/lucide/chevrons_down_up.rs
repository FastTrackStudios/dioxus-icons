...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/chevrons_down_up.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn ChevronsDownUp(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "m7 20 5-5 5 5")]),
        path(&[attr("d", "m7 4 5 5 5-5")]),
    ])];
