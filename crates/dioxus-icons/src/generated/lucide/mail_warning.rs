...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/mail_warning.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn MailWarning(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        ...
        path(&[attr("d", "M20 14v4")]),
        path(&[attr("d", "M20 22v.01")]),
    ])];
