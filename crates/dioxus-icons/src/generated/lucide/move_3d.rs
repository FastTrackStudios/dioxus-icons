...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/move_3d.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn Move3d(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "M5 3v16h16")]),
        path(&[attr("d", "m5 19 6-6")]),
        path(&[attr("d", "m2 6 3-3 3 3")]),
        path(&[attr("d", "m18 16 3 3-3 3")]),
    ])];
