...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/square_arrow_out_up_left.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn SquareArrowOutUpLeft(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr(
            "d",
            "M13 3h6a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-6",
        )]),
        path(&[attr("d", "m3 3 9 9")]),
        path(&[attr("d", "M3 9V3h6")]),
    ])];
