...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/text_search.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn TextSearch(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "M21 5H3")]),
        path(&[attr("d", "M10 12H3")]),
        path(&[attr("d", "M10 19H3")]),
        circle(&[attr("cx", "17"), attr("cy", "15"), attr("r", "3")]),
        path(&[attr("d", "m21 19-1.9-1.9")]),
    ])];
