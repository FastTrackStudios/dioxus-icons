...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/file_search.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn FileSearch(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        ...
        circle(&[attr("cx", "11.5"), attr("cy", "14.5"), attr("r", "2.5")]),
        path(&[attr("d", "M13.3 16.3 15 18")]),
    ])];
