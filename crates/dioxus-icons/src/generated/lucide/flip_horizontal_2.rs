...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/flip_horizontal_2.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn FlipHorizontal2(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "m3 7 5 5-5 5V7")]),
        path(&[attr("d", "m21 7-5 5 5 5V7")]),
