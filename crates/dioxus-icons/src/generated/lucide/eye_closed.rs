...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/eye_closed.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn EyeClosed(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "m15 18-.722-3.25")]),
        path(&[attr("d", "M2 8a10.645 10.645 0 0 0 20 0")]),
        path(&[attr("d", "m20 15-1.726-2.05")]),
        path(&[attr("d", "m4 15 1.726-2.05")]),
        path(&[attr("d", "m9 18 .722-3.25")]),
    ])];
