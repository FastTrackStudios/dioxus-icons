...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/bot_off.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn BotOff(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "M13.67 8H18a2 2 0 0 1 2 2v4.33")]),
        path(&[attr("d", "M2 14h2")]),
