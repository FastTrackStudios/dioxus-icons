...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/glasses.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn Glasses(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        circle(&[attr("cx", "6"), attr("cy", "15"), attr("r", "4")]),
        circle(&[attr("cx", "18"), attr("cy", "15"), attr("r", "4")]),
        path(&[attr("d", "M14 15a2 2 0 0 0-2-2 2 2 0 0 0-2 2")]),
        path(&[attr("d", "M2.5 13 5 7c.7-1.3 1.4-2 3-2")]),
        path(&[attr("d", "M21.5 13 19 7c-.7-1.3-1.5-2-3-2")]),
    ])];
