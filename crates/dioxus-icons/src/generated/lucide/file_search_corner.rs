...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/file_search_corner.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn FileSearchCorner(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        ...
        path(&[attr("d", "m21 22-2.88-2.88")]),
        circle(&[attr("cx", "16"), attr("cy", "17"), attr("r", "3")]),
    ])];
