...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/circle_pound_sterling.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn CirclePoundSterling(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        circle(&[attr("cx", "12"), attr("cy", "12"), attr("r", "10")]),
        path(&[attr("d", "M10 16V9.5a1 1 0 0 1 5 0")]),
        path(&[attr("d", "M8 12h4")]),
        path(&[attr("d", "M8 16h7")]),
    ])];
