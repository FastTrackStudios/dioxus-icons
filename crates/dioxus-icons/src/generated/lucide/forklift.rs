...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/forklift.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn Forklift(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "M12 12H5a2 2 0 0 0-2 2v5")]),
        path(&[attr("d", "M15 19h7")]),
        path(&[attr("d", "M16 19V2")]),
        path(&[attr(
            "d",
            "M6 12V7a2 2 0 0 1 2-2h2.172a2 2 0 0 1 1.414.586l3.828 3.828A2 2 0 0 1 16 10.828",
        )]),
        path(&[attr("d", "M7 19h4")]),
        circle(&[attr("cx", "13"), attr("cy", "19"), attr("r", "2")]),
