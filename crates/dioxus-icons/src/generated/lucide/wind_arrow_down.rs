...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/wind_arrow_down.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn WindArrowDown(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "M10 2v8")]),
        path(&[attr("d", "M12.8 21.6A2 2 0 1 0 14 18H2")]),
        path(&[attr("d", "M17.5 10a2.5 2.5 0 1 1 2 4H2")]),
        path(&[attr("d", "m6 6 4 4 4-4")]),
    ])];
