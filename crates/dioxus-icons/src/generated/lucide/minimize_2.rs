...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/minimize_2.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn Minimize2(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "m14 10 7-7")]),
        path(&[attr("d", "M20 10h-6V4")]),
        path(&[attr("d", "m3 21 7-7")]),
        path(&[attr("d", "M4 14h6v6")]),
    ])];
