...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/citrus.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn Citrus(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr(
            "d",
            "M21.66 17.67a1.08 1.08 0 0 1-.04 1.6A12 12 0 0 1 4.73 2.38a1.1 1.1 0 0 1 1.61-.04z",
        )]),
        path(&[attr("d", "M19.65 15.66A8 8 0 0 1 8.35 4.34")]),
        path(&[attr("d", "m14 10-5.5 5.5")]),
        path(&[attr("d", "M14 17.85V10H6.15")]),
    ])];
