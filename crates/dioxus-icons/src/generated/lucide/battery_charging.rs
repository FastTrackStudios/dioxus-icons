...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/battery_charging.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn BatteryCharging(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "m11 7-3 5h4l-3 5")]),
        path(&[attr(
            "d",
            "M14.856 6H16a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2h-2.935",
        )]),
        path(&[attr("d", "M22 14v-4")]),
        path(&[attr("d", "M5.14 18H4a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h2.936")]),
    ])];
