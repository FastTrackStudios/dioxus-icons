...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/ship.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn Ship(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "M12 10.189V14")]),
        path(&[attr("d", "M12 2v3")]),
        path(&[attr("d", "M19 13V7a2 2 0 0 0-2-2H7a2 2 0 0 0-2 2v6")]),
        path(&[attr(
            "d",
