...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/square_terminal.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn SquareTerminal(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "m7 11 2-2-2-2")]),
        path(&[attr("d", "M11 13h4")]),
        rect(&[
            attr("height", "18"),
            attr("rx", "2"),
            attr("ry", "2"),
