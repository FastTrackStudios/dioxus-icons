...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/list_tree.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn ListTree(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "M8 5h13")]),
        path(&[attr("d", "M13 12h8")]),
        path(&[attr("d", "M13 19h8")]),
        path(&[attr("d", "M3 10a2 2 0 0 0 2 2h3")]),
        path(&[attr("d", "M3 5v12a2 2 0 0 0 2 2h3")]),
    ])];
