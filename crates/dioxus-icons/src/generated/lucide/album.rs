...
use crate::IconProps;
use crate::vdom::{attr, icon_element, icon_template, polyline, rect, svg};

#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/album.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn Album(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        ...
        polyline(&[attr("points", "11 3 11 11 14 8 17 11 17 3")]),
    ])];
