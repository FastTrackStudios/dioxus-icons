...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/arrow_left_right.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn ArrowLeftRight(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "M8 3 4 7l4 4")]),
        path(&[attr("d", "M4 7h16")]),
        path(&[attr("d", "m16 21 4-4-4-4")]),
        path(&[attr("d", "M20 17H4")]),
    ])];
