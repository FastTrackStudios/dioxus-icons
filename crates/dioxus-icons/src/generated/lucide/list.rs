...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/list.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn List(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "M3 5h.01")]),
        path(&[attr("d", "M3 12h.01")]),
        path(&[attr("d", "M3 19h.01")]),
        path(&[attr("d", "M8 5h13")]),
        path(&[attr("d", "M8 12h13")]),
        path(&[attr("d", "M8 19h13")]),
    ])];
