...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/circle_small.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn CircleSmall(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[circle(&[
        attr("cx", "12"),
        attr("cy", "12"),
        attr("r", "6"),
    ])])];
