...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/turkish_lira.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn TurkishLira(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "M15 4 5 9")]),
        path(&[attr("d", "m15 8.5-10 5")]),
        path(&[attr("d", "M18 12a9 9 0 0 1-9 9V3")]),
    ])];
