...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/square_arrow_out_down_right.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn SquareArrowOutDownRight(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr(
            "d",
            "M21 11V5a2 2 0 0 0-2-2H5a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h6",
        )]),
        path(&[attr("d", "m21 21-9-9")]),
        path(&[attr("d", "M21 15v6h-6")]),
    ])];
