...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/chevrons_right_left.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn ChevronsRightLeft(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "m20 17-5-5 5-5")]),
        path(&[attr("d", "m4 17 5-5-5-5")]),
    ])];
