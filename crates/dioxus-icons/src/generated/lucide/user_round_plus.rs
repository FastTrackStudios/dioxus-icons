...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/user_round_plus.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn UserRoundPlus(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "M2 21a8 8 0 0 1 13.292-6")]),
        circle(&[attr("cx", "10"), attr("cy", "8"), attr("r", "5")]),
        path(&[attr("d", "M19 16v6")]),
        path(&[attr("d", "M22 19h-6")]),
    ])];
