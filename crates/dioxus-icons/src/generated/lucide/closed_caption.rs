...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/closed_caption.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn ClosedCaption(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "M10 9.17a3 3 0 1 0 0 5.66")]),
        path(&[attr("d", "M17 9.17a3 3 0 1 0 0 5.66")]),
        rect(&[
            attr("height", "14"),
            attr("rx", "2"),
            attr("width", "20"),
