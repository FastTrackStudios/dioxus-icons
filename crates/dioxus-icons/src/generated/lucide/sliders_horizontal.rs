...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/sliders_horizontal.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn SlidersHorizontal(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "M10 5H3")]),
        path(&[attr("d", "M12 19H3")]),
        path(&[attr("d", "M14 3v4")]),
        path(&[attr("d", "M16 17v4")]),
        path(&[attr("d", "M21 12h-9")]),
        path(&[attr("d", "M21 19h-5")]),
        path(&[attr("d", "M21 5h-7")]),
        path(&[attr("d", "M8 10v4")]),
        path(&[attr("d", "M8 12H3")]),
    ])];
