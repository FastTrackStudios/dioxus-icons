...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/message_circle_code.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn MessageCircleCode(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "m10 9-3 3 3 3")]),
        path(&[attr("d", "m14 15 3-3-3-3")]),
        path(&[attr(
            "d",
