...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/metronome.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn Metronome(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "M12 11.4V9.1")]),
        path(&[attr("d", "m12 17 6.59-6.59")]),
        path(&[attr(
            "d",
            "m15.05 5.7-.218-.691a3 3 0 0 0-5.663 0L4.418 19.695A1 1 0 0 0 5.37 21h13.253a1 1 0 0 0 .951-1.31L18.45 16.2",
        )]),
        circle(&[attr("cx", "20"), attr("cy", "9"), attr("r", "2")]),
    ])];
