...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/signal.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn Signal(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "M2 20h.01")]),
        path(&[attr("d", "M7 20v-4")]),
        path(&[attr("d", "M12 20v-8")]),
        path(&[attr("d", "M17 20V8")]),
        path(&[attr("d", "M22 4v16")]),
    ])];
