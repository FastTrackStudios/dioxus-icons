...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/zodiac_pisces.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn ZodiacPisces(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "M19 21a15 15 0 0 1 0-18")]),
        path(&[attr("d", "M20 12H4")]),
        path(&[attr("d", "M5 3a15 15 0 0 1 0 18")]),
    ])];
