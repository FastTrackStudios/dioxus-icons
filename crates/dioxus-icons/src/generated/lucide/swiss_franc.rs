...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/swiss_franc.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn SwissFranc(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "M10 21V3h8")]),
        path(&[attr("d", "M6 16h9")]),
        path(&[attr("d", "M10 9.5h7")]),
    ])];
