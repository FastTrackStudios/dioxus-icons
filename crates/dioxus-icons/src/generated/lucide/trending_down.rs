...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/trending_down.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn TrendingDown(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "M16 17h6v-6")]),
        path(&[attr("d", "m22 17-8.5-8.5-5 5L2 7")]),
    ])];
