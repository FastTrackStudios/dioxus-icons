...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/folder_git_2.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn FolderGit2(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "M18 19a5 5 0 0 1-5-5v8")]),
        path(&[attr(
            "d",
            "M9 20H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h3.9a2 2 0 0 1 1.69.9l.81 1.2a2 2 0 0 0 1.67.9H20a2 2 0 0 1 2 2v5",
        )]),
        circle(&[attr("cx", "13"), attr("cy", "12"), attr("r", "2")]),
