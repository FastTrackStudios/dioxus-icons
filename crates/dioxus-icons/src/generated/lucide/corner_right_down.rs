...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/corner_right_down.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn CornerRightDown(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "m10 15 5 5 5-5")]),
        path(&[attr("d", "M4 4h7a4 4 0 0 1 4 4v12")]),
    ])];
