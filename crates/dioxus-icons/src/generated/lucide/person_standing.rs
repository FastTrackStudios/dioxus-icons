...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/person_standing.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn PersonStanding(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        circle(&[attr("cx", "12"), attr("cy", "5"), attr("r", "1")]),
        path(&[attr("d", "m9 20 3-6 3 6")]),
        path(&[attr("d", "m6 8 6 2 6-2")]),
        path(&[attr("d", "M12 10v4")]),
    ])];
