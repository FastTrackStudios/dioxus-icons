...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/undo_dot.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn UndoDot(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "M21 17a9 9 0 0 0-15-6.7L3 13")]),
        path(&[attr("d", "M3 7v6h6")]),
