...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/loader_pinwheel.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn LoaderPinwheel(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "M22 12a1 1 0 0 1-10 0 1 1 0 0 0-10 0")]),
        path(&[attr("d", "M7 20.7a1 1 0 1 1 5-8.7 1 1 0 1 0 5-8.6")]),
        path(&[attr("d", "M7 3.3a1 1 0 1 1 5 8.6 1 1 0 1 0 5 8.6")]),
