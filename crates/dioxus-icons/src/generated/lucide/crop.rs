...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/crop.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn Crop(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "M6 2v14a2 2 0 0 0 2 2h14")]),
        path(&[attr("d", "M18 22V8a2 2 0 0 0-2-2H2")]),
    ])];
