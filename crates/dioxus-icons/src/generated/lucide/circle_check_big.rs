...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/circle_check_big.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn CircleCheckBig(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "M21.801 10A10 10 0 1 1 17 3.335")]),
        path(&[attr("d", "m9 11 3 3L22 4")]),
    ])];
