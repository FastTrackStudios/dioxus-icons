...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/wifi_zero.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn WifiZero(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[path(&[attr("d", "M12 20h.01")])])];
