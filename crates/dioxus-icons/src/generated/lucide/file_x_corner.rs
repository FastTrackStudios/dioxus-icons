...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/file_x_corner.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn FileXCorner(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        ...
        path(&[attr("d", "m15 17 5 5")]),
        path(&[attr("d", "m20 17-5 5")]),
    ])];
