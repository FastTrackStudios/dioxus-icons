...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/funnel_x.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn FunnelX(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        ...
        path(&[attr("d", "m16.5 3.5 5 5")]),
        path(&[attr("d", "m21.5 3.5-5 5")]),
    ])];
