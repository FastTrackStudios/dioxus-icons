...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/file_code_corner.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn FileCodeCorner(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        ...
        path(&[attr("d", "m5 16-3 3 3 3")]),
        path(&[attr("d", "m9 22 3-3-3-3")]),
    ])];
