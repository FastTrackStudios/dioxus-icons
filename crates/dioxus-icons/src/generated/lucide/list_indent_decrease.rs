...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/list_indent_decrease.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn ListIndentDecrease(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "M21 5H11")]),
        path(&[attr("d", "M21 12H11")]),
        path(&[attr("d", "M21 19H11")]),
        path(&[attr("d", "m7 8-4 4 4 4")]),
    ])];
