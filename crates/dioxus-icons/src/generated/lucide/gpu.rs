...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/gpu.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn Gpu(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "M2 17h18a2 2 0 0 0 2-2V7a2 2 0 0 0-2-2H2")]),
        path(&[attr("d", "M2 21V3")]),
        path(&[attr("d", "M7 17v3a1 1 0 0 0 1 1h5a1 1 0 0 0 1-1v-3")]),
        circle(&[attr("cx", "16"), attr("cy", "11"), attr("r", "2")]),
        circle(&[attr("cx", "8"), attr("cy", "11"), attr("r", "2")]),
    ])];
