...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/spell_check.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn SpellCheck(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "m6 16 6-12 6 12")]),
        path(&[attr("d", "M8 12h8")]),
        path(&[attr("d", "m16 20 2 2 4-4")]),
    ])];
