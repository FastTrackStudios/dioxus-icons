...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/arrow_right_from_line.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn ArrowRightFromLine(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "M3 5v14")]),
        path(&[attr("d", "M21 12H7")]),
        path(&[attr("d", "m15 18 6-6-6-6")]),
    ])];
