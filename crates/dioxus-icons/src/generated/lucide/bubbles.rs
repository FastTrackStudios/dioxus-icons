...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/bubbles.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn Bubbles(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "M7.001 15.085A1.5 1.5 0 0 1 9 16.5")]),
        circle(&[attr("cx", "18.5"), attr("cy", "8.5"), attr("r", "3.5")]),
        circle(&[attr("cx", "7.5"), attr("cy", "16.5"), attr("r", "5.5")]),
        circle(&[attr("cx", "7.5"), attr("cy", "4.5"), attr("r", "2.5")]),
    ])];
