...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/receipt_indian_rupee.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn ReceiptIndianRupee(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        ...
        path(&[attr("d", "M8 11h8")]),
        path(&[attr("d", "M8 7h8")]),
        path(&[attr("d", "M9 7a4 4 0 0 1 0 8H8l3 2")]),
    ])];
