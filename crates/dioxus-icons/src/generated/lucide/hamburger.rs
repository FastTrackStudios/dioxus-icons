...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/hamburger.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn Hamburger(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "M12 16H4a2 2 0 1 1 0-4h16a2 2 0 1 1 0 4h-4.25")]),
        path(&[attr(
            "d",
        ...
        path(&[attr("d", "m6.67 12 6.13 4.6a2 2 0 0 0 2.8-.4l3.15-4.2")]),
    ])];
