...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/git_compare.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn GitCompare(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        circle(&[attr("cx", "18"), attr("cy", "18"), attr("r", "3")]),
        circle(&[attr("cx", "6"), attr("cy", "6"), attr("r", "3")]),
        path(&[attr("d", "M13 6h3a2 2 0 0 1 2 2v7")]),
        path(&[attr("d", "M11 18H8a2 2 0 0 1-2-2V9")]),
    ])];
