...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/flask_round.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn FlaskRound(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "M10 2v6.292a7 7 0 1 0 4 0V2")]),
        path(&[attr("d", "M5 15h14")]),
