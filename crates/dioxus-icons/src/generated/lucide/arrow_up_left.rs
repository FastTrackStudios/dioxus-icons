...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/arrow_up_left.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn ArrowUpLeft(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "M7 17V7h10")]),
        path(&[attr("d", "M17 17 7 7")]),
    ])];
