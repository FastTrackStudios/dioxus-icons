...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/octagon_pause.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn OctagonPause(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "M10 15V9")]),
        path(&[attr("d", "M14 15V9")]),
        path(&[attr(
            "d",
