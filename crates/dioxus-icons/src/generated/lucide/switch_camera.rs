...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/switch_camera.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn SwitchCamera(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "M11 19H4a2 2 0 0 1-2-2V7a2 2 0 0 1 2-2h5")]),
        path(&[attr("d", "M13 5h7a2 2 0 0 1 2 2v10a2 2 0 0 1-2 2h-5")]),
        circle(&[attr("cx", "12"), attr("cy", "12"), attr("r", "3")]),
        path(&[attr("d", "m18 22-3-3 3-3")]),
        path(&[attr("d", "m6 2 3 3-3 3")]),
    ])];
