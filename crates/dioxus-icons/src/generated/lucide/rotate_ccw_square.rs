...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/rotate_ccw_square.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn RotateCcwSquare(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "M20 9V7a2 2 0 0 0-2-2h-6")]),
        path(&[attr("d", "m15 2-3 3 3 3")]),
        path(&[attr(
            "d",
