...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/phone_incoming.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn PhoneIncoming(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "M16 2v6h6")]),
        path(&[attr("d", "m22 2-6 6")]),
        path(&[attr(
            "d",
