...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/chevrons_left_right.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn ChevronsLeftRight(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "m9 7-5 5 5 5")]),
        path(&[attr("d", "m15 7 5 5-5 5")]),
    ])];
