...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/square_arrow_up_left.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn SquareArrowUpLeft(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        ...
        path(&[attr("d", "M8 16V8h8")]),
        path(&[attr("d", "M16 16 8 8")]),
    ])];
