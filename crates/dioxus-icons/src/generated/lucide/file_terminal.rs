...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/file_terminal.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn FileTerminal(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        ...
        path(&[attr("d", "m8 16 2-2-2-2")]),
        path(&[attr("d", "M12 18h4")]),
    ])];
