...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/file_clock.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn FileClock(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        ...
        path(&[attr("d", "M8 14v2.2l1.6 1")]),
        circle(&[attr("cx", "8"), attr("cy", "16"), attr("r", "6")]),
    ])];
