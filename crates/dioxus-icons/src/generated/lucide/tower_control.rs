...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/tower_control.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn TowerControl(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        ...
        path(&[attr("d", "M8 13v9")]),
        path(&[attr("d", "M16 22v-9")]),
        path(&[attr("d", "m9 6 1 7")]),
        path(&[attr("d", "m15 6-1 7")]),
        path(&[attr("d", "M12 6V2")]),
        path(&[attr("d", "M13 2h-2")]),
    ])];
