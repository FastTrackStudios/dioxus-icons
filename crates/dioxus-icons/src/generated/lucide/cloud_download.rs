...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/cloud_download.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn CloudDownload(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "M12 13v8l-4-4")]),
        path(&[attr("d", "m12 21 4-4")]),
        path(&[attr(
            "d",
