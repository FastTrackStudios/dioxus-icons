...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/case_lower.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn CaseLower(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "M10 9v7")]),
        path(&[attr("d", "M14 6v10")]),
        circle(&[attr("cx", "17.5"), attr("cy", "12.5"), attr("r", "3.5")]),
        circle(&[attr("cx", "6.5"), attr("cy", "12.5"), attr("r", "3.5")]),
    ])];
