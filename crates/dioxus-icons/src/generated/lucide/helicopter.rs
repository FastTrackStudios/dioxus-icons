...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/helicopter.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn Helicopter(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "M11 17v4")]),
        path(&[attr("d", "M14 3v8a2 2 0 0 0 2 2h5.865")]),
        path(&[attr("d", "M17 17v4")]),
        path(&[attr(
            "d",
