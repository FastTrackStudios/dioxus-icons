...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/chart_column_decreasing.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn ChartColumnDecreasing(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "M13 17V9")]),
        path(&[attr("d", "M18 17v-3")]),
