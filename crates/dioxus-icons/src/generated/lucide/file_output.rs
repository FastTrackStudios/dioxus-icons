...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/file_output.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn FileOutput(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        ...
        path(&[attr("d", "m5 11-3 3")]),
        path(&[attr("d", "m5 17-3-3h10")]),
    ])];
