...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/arrow_down_to_dot.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn ArrowDownToDot(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "M12 2v14")]),
        path(&[attr("d", "m19 9-7 7-7-7")]),
        circle(&[attr("cx", "12"), attr("cy", "21"), attr("r", "1")]),
    ])];
