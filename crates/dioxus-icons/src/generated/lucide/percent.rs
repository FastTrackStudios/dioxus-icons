...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/percent.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn Percent(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        ...
        circle(&[attr("cx", "6.5"), attr("cy", "6.5"), attr("r", "2.5")]),
        circle(&[attr("cx", "17.5"), attr("cy", "17.5"), attr("r", "2.5")]),
    ])];
