...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/venus_and_mars.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn VenusAndMars(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "M10 20h4")]),
        path(&[attr("d", "M12 16v6")]),
        path(&[attr("d", "M17 2h4v4")]),
        path(&[attr("d", "m21 2-5.46 5.46")]),
        circle(&[attr("cx", "12"), attr("cy", "11"), attr("r", "5")]),
    ])];
