...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/phone_call.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn PhoneCall(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "M13 2a9 9 0 0 1 9 9")]),
        path(&[attr("d", "M13 6a5 5 0 0 1 5 5")]),
        path(&[attr(
            "d",
