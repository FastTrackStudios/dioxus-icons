...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/arrow_up_right.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn ArrowUpRight(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "M7 7h10v10")]),
        path(&[attr("d", "M7 17 17 7")]),
    ])];
