...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/unfold_horizontal.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn UnfoldHorizontal(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "M16 12h6")]),
        path(&[attr("d", "M8 12H2")]),
        path(&[attr("d", "M12 2v2")]),
        path(&[attr("d", "M12 8v2")]),
        path(&[attr("d", "M12 14v2")]),
        path(&[attr("d", "M12 20v2")]),
        path(&[attr("d", "m19 15 3-3-3-3")]),
