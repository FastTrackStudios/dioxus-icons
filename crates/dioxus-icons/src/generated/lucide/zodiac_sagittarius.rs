...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/zodiac_sagittarius.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn ZodiacSagittarius(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "M15 3h6v6")]),
        path(&[attr("d", "M21 3 3 21")]),
        path(&[attr("d", "m9 9 6 6")]),
    ])];
