...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/mail_search.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn MailSearch(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr(
            "d",
            "M22 12.5V6a2 2 0 0 0-2-2H4a2 2 0 0 0-2 2v12c0 1.1.9 2 2 2h7.5",
        )]),
        path(&[attr("d", "m22 7-8.97 5.7a1.94 1.94 0 0 1-2.06 0L2 7")]),
        path(&[attr("d", "M18 21a3 3 0 1 0 0-6 3 3 0 0 0 0 6Z")]),
        circle(&[attr("cx", "18"), attr("cy", "18"), attr("r", "3")]),
        path(&[attr("d", "m22 22-1.5-1.5")]),
    ])];
