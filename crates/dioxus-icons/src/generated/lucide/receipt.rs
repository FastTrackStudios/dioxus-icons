...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/receipt.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn Receipt(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "M12 17V7")]),
        path(&[attr("d", "M16 8h-6a2 2 0 0 0 0 4h4a2 2 0 0 1 0 4H8")]),
        path(&[attr(
            "d",
