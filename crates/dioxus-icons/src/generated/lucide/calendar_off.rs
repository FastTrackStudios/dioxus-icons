...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/calendar_off.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn CalendarOff(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr(
            "d",
            "M4.2 4.2A2 2 0 0 0 3 6v14a2 2 0 0 0 2 2h14a2 2 0 0 0 1.82-1.18",
        )]),
        path(&[attr("d", "M21 15.5V6a2 2 0 0 0-2-2H9.5")]),
        path(&[attr("d", "M16 2v4")]),
        path(&[attr("d", "M3 10h7")]),
        path(&[attr("d", "M21 10h-5.5")]),
