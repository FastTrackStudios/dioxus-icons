...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/phone_outgoing.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn PhoneOutgoing(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "m16 8 6-6")]),
        path(&[attr("d", "M22 8V2h-6")]),
        path(&[attr(
            "d",
