...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/arrow_down_left.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn ArrowDownLeft(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "M17 7 7 17")]),
        path(&[attr("d", "M17 17H7V7")]),
    ])];
