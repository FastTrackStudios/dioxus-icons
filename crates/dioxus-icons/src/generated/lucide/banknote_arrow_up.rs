...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/banknote_arrow_up.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn BanknoteArrowUp(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        ...
        path(&[attr("d", "M19 22v-6")]),
        path(&[attr("d", "m22 19-3-3-3 3")]),
