...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/move_down_left.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn MoveDownLeft(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "M11 19H5V13")]),
        path(&[attr("d", "M19 5L5 19")]),
    ])];
