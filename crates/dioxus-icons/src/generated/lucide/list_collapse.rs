...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/list_collapse.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn ListCollapse(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "M10 5h11")]),
        path(&[attr("d", "M10 12h11")]),
        path(&[attr("d", "M10 19h11")]),
        path(&[attr("d", "m3 10 3-3-3-3")]),
        path(&[attr("d", "m3 20 3-3-3-3")]),
    ])];
