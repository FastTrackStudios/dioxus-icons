...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/line_dot_right_horizontal.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn LineDotRightHorizontal(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "M 3 12 L 15 12")]),
        circle(&[attr("cx", "18"), attr("cy", "12"), attr("r", "3")]),
    ])];
