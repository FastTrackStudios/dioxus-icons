...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/file_chart_column_increasing.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn FileChartColumnIncreasing(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        ...
        path(&[attr("d", "M12 18v-4")]),
        path(&[attr("d", "M16 18v-6")]),
    ])];
