...
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("docs/tornado.md"))]
#[cfg_attr(any(doc, rust_analyzer), doc = include_str!("../../../rustdoc-header.html"))]
#[allow(non_snake_case)]
pub fn Tornado(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        path(&[attr("d", "M21 4H3")]),
        path(&[attr("d", "M18 8H6")]),
        path(&[attr("d", "M19 12H9")]),
        path(&[attr("d", "M16 16h-6")]),
        path(&[attr("d", "M11 20H9")]),
    ])];
